...
type TransmitterServiceClient interface {
	StreamData(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (TransmitterService_StreamDataClient, error)
}
...
func (c *transmitterServiceClient) StreamData(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (TransmitterService_StreamDataClient, error) {
...
func (x *transmitterServiceStreamDataClient) Recv() (*TransmitterData, error) {
...
type TransmitterServiceServer interface {
	StreamData(*StreamRequest, TransmitterService_StreamDataServer) error
...
func (UnimplementedTransmitterServiceServer) StreamData(*StreamRequest, TransmitterService_StreamDataServer) error {
...
func (x *transmitterServiceStreamDataServer) Send(m *TransmitterData) error {
