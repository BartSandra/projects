...
func (x *TransmitterData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransmitterData) ProtoMessage() {}

func (x *TransmitterData) ProtoReflect() protoreflect.Message {
	mi := &file_transmitter_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransmitterData.ProtoReflect.Descriptor instead.
func (*TransmitterData) Descriptor() ([]byte, []int) {
	return file_transmitter_proto_rawDescGZIP(), []int{1}
}

func (x *TransmitterData) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *TransmitterData) GetFrequency() float64 {
	if x != nil {
		return x.Frequency
	}
	return 0
...
func (x *TransmitterData) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_transmitter_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x6c, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72,
	...
	0x60, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4a, 0x0a, 0x0a, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x1a, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65,
	0x72, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1c, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x2e, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x22, 0x00, 0x30,
	0x01, 0x42, 0x13, 0x5a, 0x11, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72,
...
var file_transmitter_proto_goTypes = []interface{}{
	(*StreamRequest)(nil),   // 0: transmitter.StreamRequest
	(*TransmitterData)(nil), // 1: transmitter.TransmitterData
}
var file_transmitter_proto_depIdxs = []int32{
	0, // 0: transmitter.TransmitterService.StreamData:input_type -> transmitter.StreamRequest
	1, // 1: transmitter.TransmitterService.StreamData:output_type -> transmitter.TransmitterData
