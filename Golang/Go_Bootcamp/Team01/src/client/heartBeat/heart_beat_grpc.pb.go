...
func (c *heartBeatServiceClient) Pulse(ctx context.Context, in *PulseRequest, opts ...grpc.CallOption) (*PulseResponse, error) {
	out := new(PulseResponse)
	err := c.cc.Invoke(ctx, "/heart.HeartBeatService/Pulse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHeartBeatServiceServer) Pulse(context.Context, *PulseRequest) (*PulseResponse, error) {
...
func _HeartBeatService_Pulse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PulseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HeartBeatServiceServer).Pulse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/heart.HeartBeatService/Pulse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeartBeatServiceServer).Pulse(ctx, req.(*PulseRequest))
	}
...
var HeartBeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "heart.HeartBeatService",
	HandlerType: (*HeartBeatServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Pulse",
			Handler:    _HeartBeatService_Pulse_Handler,
		},
	},
