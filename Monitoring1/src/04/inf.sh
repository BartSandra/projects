...
if [[ $TEMP_B1 =~ ^[0-6]$ ]]; then B1="${color_codes[$TEMP_B1]}"; fi
if [[ $TEMP_T1 =~ ^[0-6]$ ]]; then T1="${color_codes[$TEMP_T1]}"; fi
if [[ $TEMP_B2 =~ ^[0-6]$ ]]; then B2="${color_codes[$TEMP_B2]}"; fi
if [[ $TEMP_T2 =~ ^[0-6]$ ]]; then T2="${color_codes[$TEMP_T2]}"; fi
